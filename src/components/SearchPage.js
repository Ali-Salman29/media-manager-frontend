...
function SearchPage() {
  ...
  }, [dispatch, searchQuery, selectedDbs, selectedPhotographers, fromDate, toDate, page, pageSize]);
  ...
  const FiltersSection = () => (
    <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
      ...
      {/* Date Filters */}
      <div className="mb-6">
        <div className="font-semibold text-gray-700 mb-2">Date Range</div>
        <div className="space-y-3">
          ...
          <div>
            <label htmlFor="toDate" className="block text-sm text-gray-600 mb-1">
              To Date
            </label>
            <input
              type="date"
  ...
  return (
    <div className="space-y-6">
      {/* Filters - Top on mobile, right on desktop */}
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          <div className="mb-4">
            ...
            {/* Filter Tags */}
            {(selectedDbs.length > 0 || selectedPhotographers.length > 0 || fromDate || toDate) && (
        ...
        {/* Right: Filters - Only visible on desktop */}
